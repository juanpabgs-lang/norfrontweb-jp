...
// 02 — The product, in full. Linear shows the board; we show the console
// that actually runs at Vision Group. Static mock, obsessively detailed.
export function ProductShowcase() {
  const mockRef = useReveal(0.1);

  return (
    <section className="relative bg-black py-16 sm:py-28 overflow-hidden">
      <div
        className="pointer-events-none absolute inset-0"
        aria-hidden="true"
        style={{
          background: "radial-gradient(ellipse 60% 45% at 50% 55%, rgba(126,200,227,0.06), transparent 65%)",
        }}
      />
      <div className="container relative mx-auto px-5 sm:px-6 lg:px-8">
        <SectionHeading
          ...
          intro="Not a chatbot bolted onto a workflow — an operations console. Complaints arrive classified, routed, and traced before a human touches them."
        />

        <div ref={mockRef} className="mt-14">
          <div className="border border-white/10 bg-[#09090b] shadow-[0_40px_120px_-32px_rgba(126,200,227,0.14)]">
            {/* Window chrome */}
          ...
          <div className="mt-4 flex items-baseline gap-3">
            ...
            <span className="font-['JetBrains_Mono'] text-[10px] text-white/30">
              Pulsara complaint-intelligence console — live in production across 600+ Vision Group stores
            </span>
          </div>
        </div>
      </div>
